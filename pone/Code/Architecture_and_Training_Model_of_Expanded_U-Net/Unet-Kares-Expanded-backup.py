...
input_name = os.listdir('/Users/kunthar/development/gulcicek/pone/TrainingDataSet/BreastTumourImages')
output_name = os.listdir('/Users/kunthar/development/gulcicek/pone/TrainingDataSet/Expanded-3-channel-Labels')
n = len(input_name)
batch_size = 8
input_size_1 = 256
input_size_2 = 256
...
def batch_data(input_name, n, batch_size = 8, input_size_1 = 256, input_size_2 = 256):
    ...
    img1 = io.imread('/Users/kunthar/development/gulcicek/pone/TrainingDataSet/BreastTumourImages/'+input_name[rand_num]).astype("float")
    img2 = io.imread('/Users/kunthar/development/gulcicek/pone/TrainingDataSet/Expanded-3-channel-Labels/'+output_name[rand_num]).astype("float")
...
model.summary()
#kunthar iteration reduced for prediction test
#itr = 1000
itr = 20
S = []
for i in range(itr):
    ...
    #if i % 100 == 99:
save_model(model, '/Users/kunthar/development/gulcicek/pone/Code/Architecture_and_Training_Model_of_Expanded_U-Net/newunetres.h5')



#TEST

model = load_model('/Users/kunthar/development/gulcicek/pone/Code/Architecture_and_Training_Model_of_Expanded_U-Net/newunetres.h5')

test_input_name = os.listdir('/Users/kunthar/development/gulcicek/pone/TestingDataSet/Test-Expanded-BreastTumourImages')
test_output_name = os.listdir('/Users/kunthar/development/gulcicek/pone/TestingDataSet/Test-Expanded-3-channel-Labels')
n_test = len(test_input_name)

def batch_data_test(input_name, n, batch_size = 4, input_size_1 = 256, input_size_2 = 256):
    rand_num = random.randint(0, n-1)
    img1 = io.imread('/Users/kunthar/development/gulcicek/pone/TestingDataSet/Test-Expanded-BreastTumourImages/'+test_input_name[rand_num]).astype("float")
    img2 = io.imread('/Users/kunthar/development/gulcicek/pone/TestingDataSet/Test-Expanded-3-channel-Labels/'+test_output_name[rand_num]).astype("float")
    img1 = resize(img1, [input_size_1, input_size_2, 3])
    img2 = resize(img2, [input_size_1, input_size_2, 3])
    img1 = np.reshape(img1, (1, input_size_1, input_size_2, 3))
    img2 = np.reshape(img2, (1, input_size_1, input_size_2, 3))
